<script lang="ts">
	...
	onMount(() => {
		...
		tl2 = gsap.timeline({ repeat: 4, yoyo: true, repeatDelay: 0.5 });
		tl2.from('.hole', { scale: 0, yoyo: true, repeat: 1 })
			...
			.to('.herman', {
				...
				scaleX: 1.3,
				duration: 0.2,
				transformOrigin: '50% 100%', repeat: 1, yoyo: true
			})
			.to('.shadow', { opacity: 0, duration: 0.2 }, 0.7)
...
<div id="demo">
  ...
  <g id="earth">
		...
		<ellipse transform="matrix(0.9791 -0.2033 0.2033 0.9791 -24.8604 10.2725)" class="st17" cx="37.58" cy="126.16"
						 rx="22.47" ry="22.47" />
		...
		<linearGradient id="SVGID_1_" gradientUnits="userSpaceOnUse" x1="8.6565" y1="25.273" x2="58.1769" y2="44.8205">
			...
			<ellipse transform="matrix(0.8291 -0.5591 0.5591 0.8291 -88.2072 87.516)" class="st6" cx="99.06" cy="188.06"
							 rx="34.83" ry="34.83" />

					<ellipse transform="matrix(0.4312 -0.9022 0.9022 0.4312 -110.2839 195.987)" class="st7" cx="100.3" cy="185.46"
									 rx="31.96" ry="34.7" />
		...
		<path class="st15" d="M193.88,1.48L193.88,1.48c-1.3-1.67-3.7-1.97-5.37-0.67l-67.46,52.47l-7.91,11l12.61-4.96l67.46-52.47
			...
			C194.88,5.55,195.18,3.15,193.88,1.48z" />
					...
					<rect x="185.63" y="3.67" transform="matrix(0.7894 -0.6139 0.6139 0.7894 34.6067 115.8565)" class="st10"
								width="1.03" height="7.66" />

					<rect x="184.15" y="4.82" transform="matrix(0.7894 -0.6139 0.6139 0.7894 33.588 115.1901)" class="st10"
								width="1.03" height="7.66" />
	</g>

				<g id="ball">

			<ellipse transform="matrix(0.898 -0.4401 0.4401 0.898 -40.0675 94.0554)" class="st19" cx="182.8" cy="133.43"
							 rx="15.25" ry="15.25" />
